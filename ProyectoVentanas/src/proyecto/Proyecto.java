...
public class Proyecto{
    ...
    public static String encontrar(int buscar){
        
        return miGrafo.buscar(buscar);
    }
...
//                    verticesList.insertarFinal(null);
                    break;
                }
            ...
            int espacio = verticesList.size();
             if (verticesList.size()==0) {
                espacio = 1;
                 System.out.println("es ooooooooooooooooooooooooooooooooooooooooo");
             }
            Usuario[] vertices = new Usuario[espacio];            
            ...
            JOptionPane.showMessageDialog(null, "File not found: " + e.getMessage()+ "\nTry againnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
    ...
    public static void guardarGrafo(Grafo grafo, File ruta){
        ...
        Usuario[] usuarios = grafo.getUsuarios();
            for (int i = 0; i < usuarios.length; i++) {
                try{
            System.out.println(usuarios[i].getId() + " paapaaaaaaa");
            }catch(Exception e){
                JOptionPane.showMessageDialog(null, usuarios.length + "\nUsuariosleg");
            }
            }
